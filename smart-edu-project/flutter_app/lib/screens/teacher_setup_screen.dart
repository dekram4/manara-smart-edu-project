...
class _TeacherSetupScreenState extends State<TeacherSetupScreen> {
  ...
  Future<void> _save() async {
    ...
    final changed = await state.completeTeacherSetup(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('إعداد حساب المعلم',
        ...
        children: [
          Container(
            ...
            child: const Column(
              ...
              children: [
                Text('مرحباً بك في فريق منارة المعرفة',
                    style: TextStyle(
                        color: Colors.white,
                        fontSize: 22,
                        fontWeight: FontWeight.w900)),
                SizedBox(height: 8),
                Text('غيّر كلمة المرور المؤقتة قبل إدارة محتواك وطلابك.',
