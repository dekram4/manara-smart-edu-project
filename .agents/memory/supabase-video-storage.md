...
**How to apply:** Keep the video bucket public and restricted to MP4 uploads, never put the service-role key in clients, and show a clear unavailable/permission message when a stored URL cannot be opened.