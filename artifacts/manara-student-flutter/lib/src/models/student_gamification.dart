class StudentAchievement {
  ...
  factory StudentAchievement.fromMap(Map<String, dynamic> map) =>
      StudentAchievement(
        id: _text(map['id']),
...
class StudentGamification {
  ...
  factory StudentGamification.fromMap(Object? value) {
    ...
    return StudentGamification(
      ...
      lastQuizPercentage: map['lastQuizPercentage'] == null
          ? null
          : _number(map['lastQuizPercentage']),
      achievements: rawAchievements is List
          ? rawAchievements
                .whereType<Map>()
                .map(
                  (item) => StudentAchievement.fromMap(
