...
export interface StudentInfo {
  ...
  /**
   * المواد المسموح للطالب بدخولها، من مواد معلمه.
   *
   * غيابها — أو كونها فارغة — يعني «جميع المواد»، وهو سلوك النظام قبل
   * وجود هذا الحقل. فكل طالب مسجَّل اليوم يبقى على حاله بلا ترحيل، ولا
   * يُغلَق على أحد بابٌ كان مفتوحاً له بمجرّد إضافة الحقل.
   *
   * ولم تُستعمل قيمة نصّية خاصة مثل `"ALL"`: مصفوفة فارغة تقولها بلا
   * حالة ثانية يتذكّرها كل قارئ للحقل — وأيّ قارئ ينساها يفتح كل المواد
   * بدل أن يغلقها، وهو الاتجاه الآمن للخطأ.
   */
