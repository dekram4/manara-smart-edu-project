...
const AdminDashboard: React.FC<AdminDashboardProps> = ({ onLogout }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-gradient-to-br from-purple-50 to-violet-50 animate-fadeIn overflow-y-auto overflow-x-hidden">
      {/* Sidebar */}
      {mobileNavOpen && (
        <button
          type="button"
       ...
       <aside className={`fixed inset-y-0 right-0 z-50 flex w-[min(20rem,88vw)] transform flex-col bg-gradient-to-b from-purple-800 via-purple-700 to-purple-600 text-white shadow-2xl transition-transform duration-300 md:sticky md:top-0 md:h-screen md:z-auto md:w-80 md:translate-x-0 ${mobileNavOpen ? 'translate-x-0' : 'translate-x-full'}`}>
