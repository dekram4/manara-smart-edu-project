...
/**
 * يُزيل ترميز LaTeX والرموز الرياضية من نصّ الدرس.
 *
 * مادة اللغة ليس فيها معادلات، لكن النصوص تمرّ بأدوات تولّد `$...$`
 * و`\(...\)` حول ما تحسبه رياضياً — فيصل إلى الطالب سطرٌ فيه علامةُ
 * دولارٍ قبل كلمة إنجليزية ولا معنى لها. والتنقية هنا لا عند العرض:
 * ما يُحفظ في قاعدة البيانات هو ما يُقرأ، ولا طبقةَ تنظيفٍ بينهما.
 */
